...
| Get: Camera Name | Get: Firmware | Get: MAC Address | Get: Login PIN | Get: OTA status | Health check | Get: User DOB | Get: Factory Reset Status |
| ---------------- | ------------- | ---------------- | -------------- | --------------- | ------------ | ------------- | ------------------------- |
| 1                | 2             | 3                | 4              | 5               | 6            | 7             | 8                         |

| Set: Camera Name | Set: Login PIN | Set: Factory Reset | Set: Shutdown | Set: OTA update | Set: Provision Device | Set: User DOB | Set: Config Reset | Set: Time |
| ---------------- | -------------- | ------------------ | ------------- | --------------- | --------------------- | ------------- | ----------------- | --------- |
| 1                | 2              | 3                  | 4             | 5               | 6                     | 7             | 8                 | 9         |
...
| Header | Command | Sub-command | Data Length |
| ------ | ------- | ----------- | ----------- |
| Set    | Network | Wifi Client | variable    |
| 1      | 2       | 2           | 5-133       |
...
##### Example Command (Static IP)

| Header | Command | Sub-command | Data Length | SSID Len | SSID      | Enc Type | Key Len | Enc Key   | IP Address    | Subnet Mask   | CRC |
| ------ | ------- | ----------- | ----------- | -------- | --------- | -------- | ------- | --------- | ------------- | ------------- | --- |
| 1      | 2       | 2           | 5-133       | 8        | MyWiFiNet | 2        | 10      | Secure123 | 192.168.1.123 | 255.255.255.0 | 1   |

##### Example Command (DHCP)

| Header | Command | Sub-command | Data Length | SSID Len | SSID      | Enc Type | Key Len | Enc Key   | CRC |
| ------ | ------- | ----------- | ----------- | -------- | --------- | -------- | ------- | --------- | --- |
| 1      | 2       | 2           | variable    | 8        | MyWiFiNet | 2        | 10      | Secure123 | 1   |

###### Notes:
- **Data Length**: Varies based on configuration mode
  - **Static IP Mode**: Full data length including IP address and subnet mask
  - **DHCP Mode**: Shorter data length (omit IP address and subnet mask)
- **Encryption Types**:
  - `1` = Open (no auth)
  - `2` = WPA2
  - `3` = WPA3
- **IP/Subnet Mask**: 
  - For **Static IP**: Include both IP address and subnet mask
  - For **DHCP**: Omit both IP address and subnet mask - the device will obtain them automatically
- **CRC**: Checksum (1 byte).
...
### Set ETHERNET DHCP Configuration

| Header | Command | Sub-command   | Data Length | Data | CRC    |
| ------ | ------- | ------------- | ----------- | ---- | ------ |
| Set    | Network | ETHERNET DHCP | 0 bytes     | -    | 1 byte |
| 1      | 2       | 6             | 0           | -    | 1 byte |

**Note**: This command configures the Ethernet interface to use DHCP for automatic IP address assignment instead of static IP configuration.

#### Set ETHERNET DHCP Success Ack:

| Header | Command | Sub-command   | Data Length | Success/Failed flag | Data    | CRC    |
| ------ | ------- | ------------- | ----------- | ------------------- | ------- | ------ |
| Ack    | Network | ETHERNET DHCP | 1 byte      | Success             | Success | 1 byte |
| 3      | 2       | 6             | 2           | 0                   | 0       | 1 byte |

#### Set ETHERNET DHCP Error Ack:

| Header | Command | Sub-command   | Data Length | Success/Failed flag | Data       | CRC    |
| ------ | ------- | ------------- | ----------- | ------------------- | ---------- | ------ |
| Ack    | Network | ETHERNET DHCP | 1 byte      | Failed              | Error Code | 1 byte |
| 3      | 2       | 6             | 2           | 1                   | -1 to -5   | 1 byte |
...
| 4        | 6       | 5           | 1 - 32      | 0                   | ota_status | 1 byte |
...
## Get User DOB Request:

| Header | Command | Sub-command | Data Length | Data | CRC    |
| ------ | ------- | ----------- | ----------- | ---- | ------ |
| Get    | System  | User DOB    | 0 bytes     | -    | 1 byte |
| 2      | 6       | 7           | 0           | -    | 1 byte |

#### Get User DOB Success Response:

| Header   | Command | Sub-command | Data Length | Success/Failed flag | Data       | CRC    |
| -------- | ------- | ----------- | ----------- | ------------------- | ---------- | ------ |
| Response | System  | User DOB    | 11 bytes    | Success             | User DOB   | 1 byte |
| 4        | 6       | 7           | 11          | 0                   | DD-MM-YYYY | 1 byte |

#### Get User DOB Error Response:

| Header   | Command | Sub-command | Data Length | Success/Failed flag | Data       | CRC    |
| -------- | ------- | ----------- | ----------- | ------------------- | ---------- | ------ |
| Response | System  | User DOB    | 1 byte      | Failed              | Error Code | 1 byte |
| 4        | 6       | 7           | 2           | 1                   | -1 to -6   | 1 byte |




## Get factory_reset_status Request:

| Header | Command | Sub-command          | Data Length | Data | CRC    |
| ------ | ------- | -------------------- | ----------- | ---- | ------ |
| Get    | System  | factory_reset_status | 0 bytes     | -    | 1 byte |
| 2      | 6       | 8                    | 0           | -    | 1 byte |


#### Get factory_reset_status Success Response:

| Header   | Command | Sub-command          | Data Length | Success/Failed flag | Data                 | CRC    |
| -------- | ------- | -------------------- | ----------- | ------------------- | -------------------- | ------ |
| Response | System  | factory_reset_status | variable    | Success             | factory_reset_status | 1 byte |
| 4        | 6       | 8                    | 1 - 32      | 0                   | status string        | 1 byte |

**Possible Status Values**:
- `idle` - No factory reset in progress
- `in_progress` - Factory reset is currently running
- `completed` - Factory reset completed successfully
- `failed` - Factory reset failed


#### Get factory_reset_status Error Response:

| Header   | Command | Sub-command          | Data Length | Success/Failed flag | Data       | CRC    |
| -------- | ------- | -------------------- | ----------- | ------------------- | ---------- | ------ |
| Response | System  | factory_reset_status | 1 byte      | Failed              | Error Code | 1 byte |
| 4        | 6       | 8                    | 2           | 1                   | -1 to -6   | 1 byte |
...
| Header | Command | Sub-command | Data Length | Data                          | CRC    |
| ------ | ------- | ----------- | ----------- | ----------------------------- | ------ |
| Set    | System  | login_pin   | variable    | login_pin_length + login_pin + DOB | 1 byte |
| 1      | 6       | 2           | 11-42       | 1-32 bytes (PIN) + 10 bytes (DOB) | 1 byte |

**Data Format**:
1. Login PIN Length (1 byte)
2. Login PIN (1-32 bytes)
3. User DOB (10 bytes) - Format: DD-MM-YYYY

**Note**: User DOB is required for security validation. The DOB must match the stored DOB in the system.

#### Set login_pin Success ACK:

| Header | Command | Sub-command | Data Length | Success/Failed flag | Data    | CRC    |
| ------ | ------- | ----------- | ----------- | ------------------- | ------- | ------ |
| Ack    | System  | login_pin   | 1 byte      | Success             | Success | 1 byte |
| 3      | 6       | 2           | 2           | 0                   | 0       | 1 byte |
...
| Header | Command | Sub-command | Data Length | Success/Failed flag | Data       | CRC    |
| ------ | ------- | ----------- | ----------- | ------------------- | ---------- | ------ |
| Ack    | System  | login_pin   | 1 byte      | Failed              | Error Code | 1 byte |
| 3      | 6       | 2           | 2           | 1                   | -1 to -7   | 1 byte |
...
| Header | Command | Sub-command   | Data Length | Data       | CRC    |
| ------ | ------- | ------------- | ----------- | ---------- | ------ |
| Set    | System  | Factory Reset | 10 bytes    | User DOB   | 1 byte |
| 1      | 6       | 3             | 10          | DD-MM-YYYY | 1 byte |

**Note**: Factory reset will restore all settings to factory defaults including device provisioning data. Requires User DOB for security validation.
...
| Header | Command | Sub-command    | Data Length |
| ------ | ------- | -------------- | ----------- |
| Set    | System  | Provision mode | variable    |
| 1      | 6       | 6              | variable    |
...
| Manufacture Date     | 1-32 bytes           | DD-MM-YYYY                     |
...
| ------ | ------- | ----------- | ----------- | --------- | ----------------- | ----------------- | ------------- | -------------------- | ---------------- | --- |
| 1      | 6       | 6           | variable    | 17        | 88:ae:dd:65:ff:4c | 9                 | ABC123456     | 10                   | 2025/01/20       | 1   |

#### Set Provision Mode Success Ack:

| Header | Command | Sub-command    | Data Length | Success/Failed flag | Data    | CRC    |
| ------ | ------- | -------------- | ----------- | ------------------- | ------- | ------ |
| Ack    | System  | Provision mode | 1 byte      | Success             | Success | 1 byte |
| 3      | 6       | 6              | 2           | 0                   | 0       | 1 byte |

#### Set Provision Mode Error Ack:

| Header | Command | Sub-command    | Data Length | Success/Failed flag | Data       | CRC    |
| ------ | ------- | -------------- | ----------- | ------------------- | ---------- | ------ |
| Ack    | System  | Provision mode | 1 byte      | Failed              | Error Code | 1 byte |
| 3      | 6       | 6              | 2           | 1                   | -1 to -6   | 1 byte |

**Note**: Provisioning can only be done once. If device is already provisioned, this command will return success without making changes.



## Set User DOB Request:

| Header | Command | Sub-command | Data Length | Data       | CRC    |
| ------ | ------- | ----------- | ----------- | ---------- | ------ |
| Set    | System  | User DOB    | 10 bytes    | User DOB   | 1 byte |
| 1      | 6       | 7           | 10          | DD-MM-YYYY | 1 byte |

**Note**: Date format must be DD-MM-YYYY (10 characters). This DOB is used for security validation in critical operations like factory reset and login PIN changes.

#### Set User DOB Success Ack:

| Header | Command | Sub-command | Data Length | Success/Failed flag | Data    | CRC    |
| ------ | ------- | ----------- | ----------- | ------------------- | ------- | ------ |
| Ack    | System  | User DOB    | 1 byte      | Success             | Success | 1 byte |
| 3      | 6       | 7           | 2           | 0                   | 0       | 1 byte |

#### Set User DOB Error Ack:

| Header | Command | Sub-command | Data Length | Success/Failed flag | Data       | CRC    |
| ------ | ------- | ----------- | ----------- | ------------------- | ---------- | ------ |
| Ack    | System  | User DOB    | 1 byte      | Failed              | Error Code | 1 byte |
| 3      | 6       | 7           | 2           | 1                   | -1 to -6   | 1 byte |
...
| Header | Command | Sub-command         | Data Length | Data       | CRC    |
| ------ | ------- | ------------------- | ----------- | ---------- | ------ |
| Set    | System  | Configuration Reset | 10 bytes    | User DOB   | 1 byte |
| 1      | 6       | 8                   | 10          | DD-MM-YYYY | 1 byte |

**Note**: This command resets the camera configuration to factory defaults without affecting the device provisioning data (MAC address, serial number, manufacturing date). Requires User DOB for validation.

#### Configuration Reset Success Ack:

| Header | Command | Sub-command         | Data Length | Success/Failed flag | Data    | CRC    |
| ------ | ------- | ------------------- | ----------- | ------------------- | ------- | ------ |
| Ack    | System  | Configuration Reset | 1 byte      | Success             | Success | 1 byte |
| 3      | 6       | 8                   | 2           | 0                   | 0       | 1 byte |

#### Configuration Reset Error Ack:

| Header | Command | Sub-command         | Data Length | Success/Failed flag | Data       | CRC    |
| ------ | ------- | ------------------- | ----------- | ------------------- | ---------- | ------ |
| Ack    | System  | Configuration Reset | 1 byte      | Failed              | Error Code | 1 byte |
| 3      | 6       | 8                   | 2           | 1                   | -1 to -7   | 1 byte |

**Error Codes for Configuration Reset**:
- **-5**: Invalid DOB format/length
- **-6**: User DOB not set in system
- **-7**: User DOB validation failed (mismatch)
...
| Header | Command | Sub-command | Data Length | Data       | CRC    |
| ------ | ------- | ----------- | ----------- | ---------- | ------ |
| Set    | System  | Set Time    | variable    | Epoch Time | 1 byte |
| 1      | 6       | 9           | 1-32        | Epoch Time | 1 byte |

**Note**: Time should be provided as Unix epoch time (seconds since January 1, 1970 UTC). Example: 1737388800 represents 2025-01-20 12:00:00 UTC.

#### Set System Time Success Ack:

| Header | Command | Sub-command | Data Length | Success/Failed flag | Data    | CRC    |
| ------ | ------- | ----------- | ----------- | ------------------- | ------- | ------ |
| Ack    | System  | Set Time    | 1 byte      | Success             | Success | 1 byte |
| 3      | 6       | 9           | 2           | 0                   | 0       | 1 byte |

#### Set System Time Error Ack:

| Header | Command | Sub-command | Data Length | Success/Failed flag | Data       | CRC    |
| ------ | ------- | ----------- | ----------- | ------------------- | ---------- | ------ |
| Ack    | System  | Set Time    | 1 byte      | Failed              | Error Code | 1 byte |
| 3      | 6       | 9           | 2           | 1                   | -1 to -6   | 1 byte |
