...
int8_t set_image_video_frequency_l1(const uint8_t data_length, const uint8_t *data);
...
int8_t get_image_video_frequency_l1(const uint8_t data_length, const uint8_t *data, uint8_t **res_data_bytes, uint8_t *res_data_bytes_size);
