...
int8_t set_network_command(const uint8_t sub_command, const uint8_t data_length,
                           const uint8_t *data) {
  switch (sub_command) {
...
/*int8_t set_network_IPAddressSubnetMask(const uint8_t data_length, const
uint8_t *data) { if(data_length == 8) { if(set_ipaddress_subnetmask_l2(data) ==
0) { return 0;
        }
...
int8_t set_ethernet_ip_address_l1(const uint8_t data_length,
                                  const uint8_t *data) {
 ...
 * NETWORK GET COMMAND
 * */
int8_t get_network_command(const uint8_t sub_command, const uint8_t data_length,
  ...
  case WifiHotspot:
    return get_network_WifiHotspot(data_length, data, res_data_bytes,
                                   res_data_bytes_size);
  case WifiClient:
    return get_network_WifiClient(data_length, data, res_data_bytes,
                                  res_data_bytes_size);
  case WifiState:
    return get_wifi_state_l1(data_length, data, res_data_bytes,
                             res_data_bytes_size);
  case ETHERNET:
    return get_ethernet_l1(data_length, data, res_data_bytes,
                           res_data_bytes_size);
  case Onvif:
...
// asdfasdfasdf /
/*int8_t get_network_IPAddressSubnetMask(const uint8_t data_length, const
uint8_t *data, uint8_t **res_data_bytes, uint8_t *res_data_bytes_size) {
    if(data_length == 0) {
        int8_t ret = get_ipaddress_subnetmask_l2(res_data_bytes,
res_data_bytes_size); if(ret == 0) {
            // return 0;
        }
        printf("error in executing the command\n");
        return -1;
...
int8_t get_network_WifiHotspot(const uint8_t data_length, const uint8_t *data,
...
int8_t get_network_WifiClient(const uint8_t data_length, const uint8_t *data,
                              uint8_t **res_data_bytes,
                              uint8_t *res_data_bytes_size) {
  (void)data;
  if (data_length == 0) {
...
// int8_t get_wifi_state(const uint8_t data_length, const uint8_t *data, uint8_t
// **res_data_bytes, uint8_t *res_data_bytes_size) {
//     if(data_length == 0) {
//         int8_t wifi_state = get_wifi_state_l2(res_data_bytes,
//         res_data_bytes_size); printf("wifi_state=%d\n", wifi_state);
//         if(res_data_bytes > 0) {
...
int8_t get_wifi_state_l1(const uint8_t data_length, const uint8_t *data,
                         uint8_t **res_data_bytes,
                         uint8_t *res_data_bytes_size) {
  (void)data;
  if (data_length == 0) {
    ...
    printf("wifi_state=%d\n", wifi_state);
    if (wifi_state >= 0) {
      // The res_data_bytes and res_data_bytes_size should be set by
      // get_wifi_state_l2
      return 0;
    }
    printf("error in executing the command\n");
...
int8_t get_ethernet_l1(const uint8_t data_length, const uint8_t *data,
...
int8_t get_onvif_interface_l1(const uint8_t data_length, const uint8_t *data,
                              uint8_t **res_data_bytes,
                              uint8_t *res_data_bytes_size) {
  (void)data;
  if (data_length == 0) {
    int8_t onvif_interface_state =
        get_onvif_interface_state_l2(res_data_bytes, res_data_bytes_size);
