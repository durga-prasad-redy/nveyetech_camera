...
int8_t set_streaming_command(const uint8_t sub_command,
...
int8_t get_streaming_command(const uint8_t sub_command,
                             const uint8_t data_length, const uint8_t *data,
                             uint8_t **res_data_bytes,
                             uint8_t *res_data_bytes_size) {
  switch (sub_command) {
  case STREAM_STATE:
    return get_streaming_state(data_length, data, res_data_bytes,
                               res_data_bytes_size);
  case WEBRTC_STREAMING_STATUS:
    return get_webrtc_streaming_state_l1(data_length, data, res_data_bytes,
                                         res_data_bytes_size);
...
int8_t start_webrtc_streaming_l1(const uint8_t data_length,
                                 const uint8_t *data) {
  (void)data;
  if (data_length == 0) {
...
int8_t stop_webrtc_streaming_l1(const uint8_t data_length,
                                const uint8_t *data) {
  (void)data;
  if (data_length == 0) {
...
int8_t get_streaming_state(const uint8_t data_length, const uint8_t *data,
                           uint8_t **res_data_bytes,
                           uint8_t *res_data_bytes_size) {
  (void)data;
  if (data_length == 0) {
...
int8_t get_webrtc_streaming_state_l1(const uint8_t data_length,
                                     const uint8_t *data,
                                     uint8_t **res_data_bytes,
                                     uint8_t *res_data_bytes_size) {
  (void)data;
  if (data_length == 0) {
    int8_t ret =
        get_webrtc_streaming_state_l2(res_data_bytes, res_data_bytes_size);
    if (ret == 0) {
