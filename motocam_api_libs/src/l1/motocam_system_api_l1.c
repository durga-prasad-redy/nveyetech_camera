...
int8_t set_system_command(const uint8_t sub_command, const uint8_t data_length,
                          const uint8_t *data) {
  switch (sub_command) {
  case SETCAMERANAME:
...
int8_t set_system_factory_reset_l1(const uint8_t data_length,
                                   const uint8_t *data) {
  // Expected format: DOB (10 bytes, dd-mm-yyyy)
  if (data_length != 10) {
    printf("set_system_factory_reset_l1: invalid data length %d, expected 10 "
           "(DOB)\n",
           data_length);
    return -5;
  }
...
int8_t set_system_config_reset_l1(const uint8_t data_length,
                                  const uint8_t *data) {
  // Expected format: DOB (10 bytes, dd-mm-yyyy)
  if (data_length != 10) {
    printf("set_system_config_reset_l1: invalid data length %d, expected 10 "
           "(DOB)\n",
           data_length);
    return -5;
  }
...
int8_t set_system_camera_name_l1(const uint8_t data_length,
                                 const uint8_t *data) {
  (void)data;
...
int8_t set_system_login_l1(const uint8_t data_length, const uint8_t *data) {
  // Expected format: login_pin_length (1 byte) + login_pin (variable) + DOB (10
  // bytes) Minimum: 1 + 1 + 10 = 12 bytes Maximum: 1 + 32 + 10 = 43 bytes
  ...
  int8_t ret =
      set_system_login_l2(login_pin_length, login_pin, dob_length, dob);
  if (ret == 0) {
    return 0;
  } else if (ret == -6) {
 ...
 * System Get
 * */
int8_t get_system_command(const uint8_t sub_command, const uint8_t data_length,
                          const uint8_t *data, uint8_t **res_data_bytes,
                          uint8_t *res_data_bytes_size) {
  switch (sub_command) {
    //        case IPAddressSubnetMask:
    //            return get_network_IPAddressSubnetMask(data_length, data,
    //            res_data_bytes, res_data_bytes_size);
  case GETCAMERANAME:
    return get_system_camera_name_l1(data_length, data, res_data_bytes,
                                     res_data_bytes_size);
  case FIRMWAREVERSION:
    return get_system_firmware_version_l1(data_length, data, res_data_bytes,
                                          res_data_bytes_size);
  case MACADDRESS:
    return get_system_mac_address_l1(data_length, data, res_data_bytes,
                                     res_data_bytes_size);
  case LOGIN:
    return login_with_pin_l1(data_length, data, res_data_bytes,
                             res_data_bytes_size);
  case OTA_UPDATE_STATUS:
    return get_ota_update_status_l1(data_length, data, res_data_bytes,
                                    res_data_bytes_size);

  case HEALTH_CHECK:
    return get_camera_health_l1(data_length, data, res_data_bytes,
                                res_data_bytes_size);
  case GET_USER_DOB:
    return get_system_user_dob_l1(data_length, data, res_data_bytes,
                                  res_data_bytes_size);
  default:
...
int8_t get_system_camera_name_l1(const uint8_t data_length, const uint8_t *data,
...
int8_t get_system_firmware_version_l1(const uint8_t data_length,
                                      const uint8_t *data,
                                      uint8_t **res_data_bytes,
                                      uint8_t *res_data_bytes_size) {
  (void)data;
  if (data_length == 0) {
    int8_t ret =
        get_system_firmware_version_l2(res_data_bytes, res_data_bytes_size);
    if (ret == 0) {
      return 0;
    }
    printf("error in executing the command\n");
...
int8_t get_system_mac_address_l1(const uint8_t data_length, const uint8_t *data,
                                 uint8_t **res_data_bytes,
                                 uint8_t *res_data_bytes_size) {
  (void)data;
  if (data_length == 0) {
...
int8_t get_ota_update_status_l1(const uint8_t data_length, const uint8_t *data,
                                uint8_t **res_data_bytes,
                                uint8_t *res_data_bytes_size) {
  (void)data;
  if (data_length == 0) {
...
int8_t get_camera_health_l1(const uint8_t data_length, const uint8_t *data,
                            uint8_t **res_data_bytes,
                            uint8_t *res_data_bytes_size) {
  (void)data;
  if (data_length == 0) {
...
int8_t login_with_pin_l1(const uint8_t data_length, const uint8_t *data,
                         uint8_t **res_data_bytes,
                         uint8_t *res_data_bytes_size) {
  ...
  int8_t ret =
      login_with_pin_l2(data_length, data, res_data_bytes, res_data_bytes_size);
  if (ret == 0) {
...
int8_t get_system_user_dob_l1(const uint8_t data_length, const uint8_t *data,
                              uint8_t **res_data_bytes,
                              uint8_t *res_data_bytes_size) {
  (void)data;
  if (data_length != 0) {
...
int8_t set_system_haptic_motor_l1(const uint8_t data_length,
                                  const uint8_t *data) {
  (void)data;
  if (data_length == 0) {
