...
int8_t set_image_command(const uint8_t sub_command, const uint8_t data_length,
                         const uint8_t *data) {
  switch (sub_command) {
  case ZOOM:
...
int8_t set_image_ircutfilter_l1(const uint8_t data_length,
                                const uint8_t *data) {
  if (data_length == 1) {
...
int8_t set_image_irbrightness_l1(const uint8_t data_length,
                                 const uint8_t *data) {
  if (data_length == 1) {
...
int8_t set_image_mid_irbrightness_l1(const uint8_t data_length,
                                     const uint8_t *data) {
  if (data_length == 1) {
...
int8_t set_image_side_irbrightness_l1(const uint8_t data_length,
                                      const uint8_t *data) {
  if (data_length == 1) {
...
int8_t get_image_command(const uint8_t sub_command, const uint8_t data_length,
                         const uint8_t *data, uint8_t **res_data_bytes,
                         uint8_t *res_data_bytes_size) {
  switch (sub_command) {
  case ZOOM:
    return get_image_zoom_l1(data_length, data, res_data_bytes,
                             res_data_bytes_size);
  case ROTATION:
    return get_image_rotation_l1(data_length, data, res_data_bytes,
                                 res_data_bytes_size);
  case IRCUTFILTER:
    return get_image_ircutfilter_l1(data_length, data, res_data_bytes,
                                    res_data_bytes_size);
  case IRBRIGHTNESS:
    return get_image_irbrightness_l1(data_length, data, res_data_bytes,
                                     res_data_bytes_size);
  case DAYMODE:
    return get_image_daymode_l1(data_length, data, res_data_bytes,
                                res_data_bytes_size);
  case RESOLUTION:
    return get_image_resolution_l1(data_length, data, res_data_bytes,
                                   res_data_bytes_size);
  case MIRROR:
    return get_image_mirror_l1(data_length, data, res_data_bytes,
                               res_data_bytes_size);
  case FLIP:
    return get_image_flip_l1(data_length, data, res_data_bytes,
                             res_data_bytes_size);
  case TILT:
    return get_image_tilt_l1(data_length, data, res_data_bytes,
                             res_data_bytes_size);
  case WDR:
    return get_image_wdr_l1(data_length, data, res_data_bytes,
                            res_data_bytes_size);
  case EIS:
...
int8_t get_image_zoom_l1(const uint8_t data_length, const uint8_t *data,
...
int8_t get_image_rotation_l1(const uint8_t data_length, const uint8_t *data,
                             uint8_t **res_data_bytes,
                             uint8_t *res_data_bytes_size) {
  (void)data;
  if (data_length == 0) {
...
int8_t get_image_ircutfilter_l1(const uint8_t data_length, const uint8_t *data,
                                uint8_t **res_data_bytes,
                                uint8_t *res_data_bytes_size) {
  (void)data;
  if (data_length == 0) {
...
int8_t get_image_irbrightness_l1(const uint8_t data_length, const uint8_t *data,
                                 uint8_t **res_data_bytes,
                                 uint8_t *res_data_bytes_size) {
  (void)data;
  if (data_length == 0) {
...
int8_t get_image_daymode_l1(const uint8_t data_length, const uint8_t *data,
                            uint8_t **res_data_bytes,
                            uint8_t *res_data_bytes_size) {
  (void)data;
  if (data_length == 0) {
...
int8_t get_image_gyroreader_l1(const uint8_t data_length, const uint8_t *data,
                               uint8_t **res_data_bytes,
                               uint8_t *res_data_bytes_size) {
  (void)data;
  if (data_length == 0) {
...
int8_t get_image_resolution_l1(const uint8_t data_length, const uint8_t *data,
                               uint8_t **res_data_bytes,
                               uint8_t *res_data_bytes_size) {
  (void)data;
  if (data_length == 0) {
...
int8_t get_image_mirror_l1(const uint8_t data_length, const uint8_t *data,
                           uint8_t **res_data_bytes,
                           uint8_t *res_data_bytes_size) {
  (void)data;
  if (data_length == 0) {
...
int8_t get_image_flip_l1(const uint8_t data_length, const uint8_t *data,
                         uint8_t **res_data_bytes,
                         uint8_t *res_data_bytes_size) {
  (void)data;
  if (data_length == 0) {
...
int8_t get_image_tilt_l1(const uint8_t data_length, const uint8_t *data,
                         uint8_t **res_data_bytes,
                         uint8_t *res_data_bytes_size) {
  (void)data;
  if (data_length == 0) {
...
int8_t get_image_wdr_l1(const uint8_t data_length, const uint8_t *data,
                        uint8_t **res_data_bytes,
                        uint8_t *res_data_bytes_size) {
  (void)data;
  if (data_length == 0) {
...
int8_t get_image_eis_l1(const uint8_t data_length, const uint8_t *data,
                        uint8_t **res_data_bytes,
                        uint8_t *res_data_bytes_size) {
  (void)data;
  if (data_length == 0) {
