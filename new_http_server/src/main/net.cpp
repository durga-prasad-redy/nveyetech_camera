...
bool web_init()
{
    ...
    cfg.storage_type = SessionStorageType::LRU; // Assuming LRU is default or preferred
    // Cookie settings are part of SessionConfig in the header I saw?
    // In session_manager.h view:
    // SessionConfig struct has: max_sessions, eviction_queue_size, session_timeout, storage_type, cookie_domain, cookie_path, secure_cookies, http_only_cookies.
